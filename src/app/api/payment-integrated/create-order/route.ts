...
import { POST as createOrderPost } from '@/app/api/payment/create-order/route';
import { logger } from '@/lib/logger';

const SUCCESSOR_ENDPOINT = '/api/payment/create-order';
...
export async function POST(request: NextRequest): Promise<Response> {
    logger.warn({
        ...
        endpoint: '/api/payment-integrated/create-order',
        successor: SUCCESSOR_ENDPOINT,
    });

    return withLegacyHeaders(await createOrderPost(request));
}
