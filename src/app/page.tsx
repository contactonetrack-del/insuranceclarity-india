                ...
                <div className="max-w-4xl mx-auto">
                    <RevealOnScroll direction="scale">
                        ...
                        <div className="relative overflow-hidden rounded-3xl bg-white border border-slate-100
                                        shadow-[0_8px_40px_-12px_rgba(0,0,0,0.12),0_2px_8px_-2px_rgba(0,0,0,0.06)]">

                            {/* Decorative rings — top-right corner */}
                            <div className="absolute -top-20 -right-20 w-64 h-64 rounded-full border border-slate-100 pointer-events-none" />
                            <div className="absolute -top-12 -right-12 w-48 h-48 rounded-full border border-slate-100 pointer-events-none" />
                            ...
                            <div className="relative z-10 px-8 py-14 text-center">
                                ...
                                {/* Headline */}
                                <h2 className="font-display font-extrabold text-3xl md:text-4xl text-slate-900 mb-4 leading-tight">
