...
export default function CalculatorPage() {
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => {
            ...
            trackCalculatorUsed({
                type: type === 'Life Insurance' ? 'life' : type === 'Health Insurance' ? 'health' : 'motor',
    ...
    useCalculationSave('premium-calculator', { type, sumAssured, age, gender, isSmoker, occupation, location, selectedRiders, policyTerm }, performCalculation);
