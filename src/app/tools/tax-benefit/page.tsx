...
export default function TaxBenefitCalculator() {
    ...
    const taxResults = useMemo(() => {
        ...
        return {
            ...
            bestRegimeKey: taxNew < taxOld ? 'new' : 'old',
        ...
        <div className="min-h-screen pt-32 pb-20 px-6">
            <div className="max-w-7xl mx-auto">
                <header className="mb-12">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-accent/10 text-accent text-sm rounded-full mb-4 font-bold border border-accent/20">
                    ...
                    <div className="lg:col-span-5 space-y-8">
                        ...
                        >
                            <div className="text-center space-y-6">
                                ...
                                <h3 className="text-4xl font-display font-black text-theme-primary">
                                    {t('chooseRegime', { regime: '' })} <span className="text-gradient">{auditT(`regimes.${taxResults.bestRegimeKey}`)}</span>
                                </h3>

                                <div className="grid grid-cols-2 gap-4">
                                    <div className="p-5 rounded-2xl bg-white/5 border border-default text-left relative overflow-hidden">
                                        <div className={`h-1 w-full absolute top-0 left-0 ${taxResults.bestRegimeKey === 'old' ? 'bg-accent' : 'bg-slate-300'}`} />
                                    ...
                                    <div className="p-5 rounded-2xl bg-white/5 border border-default text-left relative overflow-hidden">
                                        <div className={`h-1 w-full absolute top-0 left-0 ${taxResults.bestRegimeKey === 'new' ? 'bg-accent' : 'bg-slate-300'}`} />
                                ...
                                <div className="p-6 bg-success-500/10 rounded-2xl border border-success-500/20">
                                    <p className="text-sm font-bold text-success-500 flex items-center justify-center gap-2">
                                        <Trophy className="w-4 h-4" />
                                        {t('annualSaving')}
                                    </p>
                                    <p className="text-3xl font-black text-success-500 mt-1">
                        ...
                        <div className="glass rounded-3xl p-8 border border-default">
                            ...
                            <div className="space-y-4 text-sm text-theme-secondary leading-relaxed">
                                ...
                                <div className="flex gap-3 text-success-500 font-medium">
                                ...
                                <div className="p-4 bg-slate-900 rounded-xl border border-white/10 mt-6 relative overflow-hidden">
                                    ...
                                    <p className="text-xs text-slate-400">
                                        <strong>{auditT('noteLabel')}:</strong> {t('budgetNote')}
                                    </p>
                                </div>
                            </div>
                        </div>
