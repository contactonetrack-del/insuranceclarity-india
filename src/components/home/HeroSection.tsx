        ...
        <section className="relative min-h-[90dvh] flex items-center pt-20 pb-24 px-6 -mt-20 overflow-x-clip">
            ...
            <div className="max-w-7xl mx-auto text-center relative z-10">
                ...
                <RevealOnScroll direction="up" delay={0.2}>
                    <h1 className="font-display font-extrabold text-4xl md:text-5xl lg:text-6xl text-theme-primary leading-tight mb-6 drop-shadow-lg">
                        <AnimatedHeading
                ...
                <RevealOnScroll direction="up" delay={0.55}>
                    <div className="hero-trust-row" role="list" aria-label="Trust indicators">
                        {[
                            ...
                            { icon: Star, label: '4.9/5 User Satisfaction', color: 'text-amber-500' },
