export const schemaTypes = [
    {
        ...
        fields: [
            ...
            // Advanced SEO Meta
            { name: 'seoTitle', title: 'SEO Meta Title', type: 'string', description: 'Optimal length: 50-60 characters', validation: (Rule: any) => Rule.max(65).warning('Longer titles may be truncated by search engines') },
            { name: 'seoDescription', title: 'SEO Meta Description', type: 'text', description: 'Optimal length: 150-160 characters', validation: (Rule: any) => Rule.max(160).warning('Ideally keep this under 160 characters') },
