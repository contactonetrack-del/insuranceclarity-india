...
> Historical archive: this document reflects an earlier milestone, not the current source of truth. Refer to [MASTER-PLAN-STATUS.md](../MASTER-PLAN-STATUS.md) for the live system state.
